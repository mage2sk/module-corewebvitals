<?php
/**
 * Standalone install + heartbeat reporter for Panth_CoreWebVitals.
 *
...
namespace Panth\CoreWebVitals\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_CoreWebVitals';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-corewebvitals';
